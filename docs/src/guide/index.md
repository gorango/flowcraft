...
- **Example**: Research Agent (see [Research Example](https://github.com/gorango/flowcraft/tree/master/examples/llm-workflows/research-assistant))
...
- **Example**: Parallel Workflow (see [Translation Example](https://github.com/gorango/flowcraft/tree/master/examples/llm-workflows/translation-service))
...
- **Example**: Distributed Workflow (see [Distributed Example](https://github.com/gorango/flowcraft/tree/master/examples/llm-workflows/distributed-execution))
