...
<template>
	<main class="flex flex-col h-screen bg-background p-4 gap-4">
		<div class="flex flex-col gap-1">
			<h1 class="text-lg font-semibold text-foreground">Expense Report Pipeline</h1>
		...
		<div class="flex-1 min-h-0">
			<Flow :flow="expenseFlow" :positions-map="positionsMap" :types-map="typesMap" />
		</div>
	</main>
</template>
